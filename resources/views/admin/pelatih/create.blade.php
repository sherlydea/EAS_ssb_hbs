...
<div class="page-header">
    ...
    <p class="page-desc">
        Tambahkan data pelatih baru untuk SSB HBS.
    </p>
</div>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <select name="lisensi" class="form-control form-select" required>
                    ...
                    <option value="Nasional B" {{ old('lisensi') == 'Nasional B' ? 'selected' : '' }}>Nasional B</option>
                    <option value="Nasional C" {{ old('lisensi') == 'Nasional C' ? 'selected' : '' }}>Nasional C</option>
                    <option value="Nasional D" {{ old('lisensi') == 'Nasional D' ? 'selected' : '' }}>Nasional D</option>
                </select>
            </div>
