        ...
        <div class="max-w-6xl mx-auto">
            ...
            <section class="grid grid-cols-1 lg:grid-cols-4 gap-5 mb-6">
                <div class="bg-[#fffaf0] border border-[#7a1025]/25 rounded-3xl p-6 shadow-lg">
                    ...
                    <h2 class="text-xl font-black text-[#1a0b0f]"><?php echo e($namaSiswa); ?></h2>
                    <p class="text-[#7a1025] font-bold mt-2"><?php echo e($kategori); ?></p>
                </div>

                <div class="bg-[#fffaf0] border border-[#7a1025]/25 rounded-3xl p-6 shadow-lg">
                    <p class="text-[#6f5a55] text-sm mb-2">Jadwal Latihan</p>
                    <h2 class="text-4xl font-black text-[#7a1025]"><?php echo e($totalLatihan); ?></h2>
                </div>

                <div class="bg-[#fffaf0] border border-[#7a1025]/25 rounded-3xl p-6 shadow-lg">
                    <p class="text-[#6f5a55] text-sm mb-2">Turnamen Saya</p>
                    <h2 class="text-4xl font-black text-[#7a1025]"><?php echo e($totalTurnamen); ?></h2>
                </div>

                <div class="bg-[#fffaf0] border border-[#7a1025]/25 rounded-3xl p-6 shadow-lg">
                    <p class="text-[#6f5a55] text-sm mb-2">Kehadiran</p>
                    <h2 class="text-4xl font-black text-green-600"><?php echo e($persentaseHadir); ?>%</h2>
                </div>
            </section>
            ...
            <section class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="lg:col-span-2 bg-[#fffaf0] border border-[#7a1025]/25 rounded-3xl p-7 shadow-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <a href="<?php echo e(route('siswa.jadwal-latihan')); ?>"
                        ...
                        <a href="<?php echo e(route('siswa.jadwal-turnamen')); ?>"
                           class="bg-[#7a1025] border border-[#600018] rounded-2xl p-5 hover:bg-[#600018] transition shadow-md">
                        ...
                        <a href="<?php echo e(route('siswa.jersey')); ?>"
                           class="bg-[#7a1025] border border-[#600018] rounded-2xl p-5 hover:bg-[#600018] transition shadow-md">
                            <p class="text-[#d4af37] font-bold mb-2">Jersey Saya</p>
                            <p class="text-white/85 text-sm"><?php echo e($totalJersey); ?> pesanan jersey tercatat.</p>
                        </a>

                        <a href="<?php echo e(route('siswa.riwayat-absensi')); ?>"
                           class="bg-[#7a1025] border border-[#600018] rounded-2xl p-5 hover:bg-[#600018] transition shadow-md">
                            <p class="text-[#d4af37] font-bold mb-2">Absensi Saya</p>
                            <p class="text-white/85 text-sm"><?php echo e($totalAbsensi); ?> data absensi tercatat.</p>
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-[#fffaf0] border border-[#7a1025]/25 rounded-3xl p-7 shadow-lg">
                    ...
                    <a href="<?php echo e(route('siswa.pembayaran')); ?>"
...
</html><?php /**PATH C:\Users\Asus\Documents\EAS_PEMWEB\ssb_hbs\resources\views/siswa/dashboard.blade.php ENDPATH**/ ?>