...
<header class="fixed top-0 left-0 w-full z-50 bg-[#1a0b0f]/95 backdrop-blur-xl border-b border-[#7a1025]/30 shadow-sm">
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <!-- LOGO HBS -->
      <a href="<?php echo e(url('/siswa/dashboard')); ?>" class="flex items-center gap-3">
    <img src="<?php echo e(asset('images/loho-hbs.png')); ?>" alt="Logo HBS" class="w-12 h-12 ">
    <div>
...
>
    ...
    <nav class="p-5 space-y-3 pb-28">
        <a href="<?php echo e(url('/siswa/dashboard')); ?>" class="menu-siswa-link">Dashboard</a>
        <a href="<?php echo e(url('/siswa/profil')); ?>" class="menu-siswa-link">Profil Saya</a>
        <a href="<?php echo e(url('/siswa/jadwal-latihan')); ?>" class="menu-siswa-link">Latihan Saya</a>
        <a href="<?php echo e(url('/siswa/jadwal-turnamen')); ?>" class="menu-siswa-link">Turnamen Saya</a>
        <a href="<?php echo e(url('/siswa/pembayaran')); ?>" class="menu-siswa-link">SPP Saya</a>
        <a href="<?php echo e(url('/siswa/jersey')); ?>" class="menu-siswa-link">Jersey Saya</a>
        <a href="<?php echo e(url('/siswa/riwayat-absensi')); ?>" class="menu-siswa-link">Absensi Saya</a>
    </nav>
...
</script><?php /**PATH C:\Users\Asus\Documents\EAS_PEMWEB\ssb_hbs\resources\views/siswa/partials/sidebar.blade.php ENDPATH**/ ?>