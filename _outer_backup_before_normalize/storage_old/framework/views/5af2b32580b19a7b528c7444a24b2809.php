    ...
    <style>
        ...
        .hero-bg {
            background-image:
                ...
                url("<?php echo e(asset('images/beranda.jpg')); ?>");
...
<nav class="fixed top-0 left-0 w-full z-50 bg-[#080203]/85 backdrop-blur-xl border-b border-white/10">
    ...
    <div>
        ...
        <div class="hidden md:flex items-center gap-7 text-sm font-semibold text-white/75">
            ...
            <a href="<?php echo e(route('login')); ?>" class="border border-[#d4af37] text-[#d4af37] px-6 py-2.5 rounded-full hover:bg-[#d4af37] hover:text-[#120608] transition">
                Login
            </a>
        </div>
...
<div id="mobileMenu" class="fixed top-0 right-0 w-72 h-full bg-[#140508] z-50 translate-x-full transition duration-300 border-l border-white/10 p-6">
    ...
    <div class="flex flex-col gap-5 text-white/75 font-semibold">
        ...
        <a href="<?php echo e(route('login')); ?>" class="border border-[#d4af37] text-[#d4af37] text-center py-3 rounded-full">Login</a>
    </div>
</div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 pt-24 w-full">
        <div class="max-w-3xl">
            ...
            <div class="flex flex-wrap gap-4">
                <a href="<?php echo e(route('pendaftaran.create')); ?>" class="bg-[#8d001f] px-8 py-4 rounded-xl font-bold hover:bg-[#a50028] transition">
                    Daftar Sekarang
                </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-7 flex justify-center items-center">
                <div class="relative w-full max-w-3xl rounded-3xl overflow-hidden shadow-2xl">
                    <img
                        src="<?php echo e(asset('images/tentang.jpg')); ?>"
                        alt="Tentang SSB HBS"
...
<section id="galeri" class="min-h-screen bg-[#120305] py-24">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php for($i = 1; $i <= 12; $i++): ?>
                <button type="button"
                        onclick="openLightbox('<?php echo e(asset('images/galeri/'.$i.'.jpg')); ?>')"
                        class="group overflow-hidden rounded-3xl bg-[#1a0608]">
                    <img src="<?php echo e(asset('images/galeri/'.$i.'.jpg')); ?>"
                         alt="Galeri <?php echo e($i); ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <?php $__currentLoopData = $prestasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-[#1a0608] border border-[#4e1218] rounded-3xl overflow-hidden hover:-translate-y-2 hover:border-[#d4af37]/60 transition duration-300 shadow-xl">
                    <img
                        src="<?php echo e(asset('images/prestasi/prestasi'.($index + 1).'.jpg')); ?>"
                        alt="Prestasi <?php echo e($index + 1); ?>"
...
</html><?php /**PATH C:\Users\Asus\Documents\EAS_PEMWEB\ssb_hbs\resources\views/public/index.blade.php ENDPATH**/ ?>